...
const SearchPage = () => {
    ...
    const handleAddArtist = async (artist) => {
        try {
            ...
            console.log('Adding artist with data:', artistData);
            ...
            if (response.data && response.data._id) {
                ...
                // Add the new artist to the userArtists state with the correct structure
                setUserArtists(prevArtists => [...prevArtists, {
                    ...artistData,
                ...
                console.log('Server returned invalid response:', response.data);
                                    ...
                                    <div className="mb-8">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                            {searchResults.artists.map((artist) => {
                                                const isAdded = isArtistAdded(artist.id);
                                                return (
                                                    <div key={artist.id} className="bg-[#181818] p-4 rounded-lg hover:bg-[#282828] transition-colors">
                                                        ...
                                                        <p className="text-sm bg-white text-black px-2 py-0.5 rounded-xl inline-block mb-2">Artist</p>
                                                        <button
